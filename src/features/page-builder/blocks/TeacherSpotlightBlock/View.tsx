...
import { ScrollTextReveal } from '@/shared/components/ScrollTextReveal'
import { TeacherPhotoWall } from '@/features/page-builder/blocks/TeacherSpotlightBlock/PhotoWall.client'
