...
import { SchoolLifeDivider } from '@/features/page-builder/blocks/SchoolLifeBlock/Divider.client'
import { SchoolLifeMark } from '@/features/page-builder/blocks/SchoolLifeBlock/Mark.client'
