export const itemIconOptions = [
  ...
  { label: 'Колба (наука)', value: 'flask-conical' },
  { label: 'Языки', value: 'languages' },
  { label: 'Калькулятор', value: 'calculator' },
  { label: 'Компас', value: 'compass' },
  { label: 'Глобус', value: 'globe' },
  { label: 'Хлопушка (праздник)', value: 'party-popper' },
  { label: 'Лампочка (идея)', value: 'lightbulb' },
  { label: 'Галочка', value: 'check-circle' },
  { label: 'Мишень (цель)', value: 'target' },
]
